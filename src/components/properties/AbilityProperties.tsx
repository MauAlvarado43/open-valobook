...
export function AbilityProperties({ elements, onRadiusChange, onIntermediatePointsChange }: AbilityPropertiesProps) {
  ...
  return (
    <div className="space-y-4 pt-2 border-t border-gray-800">
      {hasSmokeOrArea && (
        <div>
          {(() => {
            const abilityEl = elements.find(el => el.subType === 'smoke' || el.subType === 'area');
                  ...
                  <>
                    ...
                    <div className="flex gap-2 items-center">
                      <input
                        ...
                        step="5"
                        aria-label="Adjust ability radius"
                        title="Radius"
                      ...
                      <input
                        ...
                        min="10"
                        max={getMaxDimension(def, 'radius')}
                        aria-label="Numeric radius value"
                        title="Radius value"
                        value={abilityEl.radius || 60}
                        onChange={(e) => onRadiusChange(parseInt(e.target.value))}
            ...
            {(() => {
              ...
              return options.map((num) => (
                <button
                  ...
                  className={`px-2 py-1 rounded text-[10px] transition-colors ${currentCount === num
